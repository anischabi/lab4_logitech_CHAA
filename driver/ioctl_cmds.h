...
struct pan_tilt_request {
    int16_t pan_steps;   // déplacement relatif en pas (positif/droite, négatif/gauche)
    int16_t tilt_steps;  // déplacement relatif en pas (positif/haut, négatif/bas)
};
